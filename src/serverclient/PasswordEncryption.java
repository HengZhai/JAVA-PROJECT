...
public class PasswordEncryption {
	...
	private static SecretKeySpec getKey() {
		...
		String a = "ThisIsMyEncryptedPassword";
		...
		try {
			key = createSecretKey(a.toCharArray(), salt, iterationCount, keyLength);
	...
	public static String encrypt(String password) {
		...
		try {
			encryptedPassword = encrypt(originalPassword, getKey());
	...
	public static String decrypt(String encryptedPassword) {
		...
		try {
			decryptedPassword = decrypt(encryptedPassword, getKey());
