...
/**
 * Special sign up interface for tutors
 */
public class SignUpForTutor extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        //design the general scene of the SignUpForTutor interface
        GridPane gp=new GridPane();

        Label headerLabel = new Label("Registration for Tutor");
        ...
        gp.setLayoutX(40);
        gp.setLayoutY(50);
        //design the background of the SignUpForTutor interface
        ...
        //display the final scene of SignUpForTutor interface
        ...
        // // add button event to achieve the function of registration for tutor
        button2.setOnAction(event -> {
            ...
            if(textField1.getText().isEmpty() ||
                ...
                Client.getSocket();
                if(Client.sendMessage("17," + textField1.getText() + "," + textField2.getText() + "," + textField3.getText()
                        + "," + textField4.getText() + "," + textField6.getText() + "," + textField7.getText()).equals("success")) {
                    showAlert(Alert.AlertType.INFORMATION, gp.getScene().getWindow(), "Create Tutor Account", "Congratulations! Your tutor account has been created successfully.");
                }
            }
        });
    }
